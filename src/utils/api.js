...
export const uploadFile = (file, folder, fileName) => {
    let url = process.env.REACT_APP_UPLOAD_ENDPOINT + '/file';
...
export const isSuccessfulResponse = response => (response.status === 200 && response.data && response.data.success);